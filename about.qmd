...
This project is a blatant clone of the R-Primers created by (Andrew Heiss)[https://www.andrewheiss.com/].
The original version is hosted at <https://r-primers.andrewheiss.com/about.html>.
I'm only hosting my own copy to ensure that the content of the tutorials doesn't
change in the middle of a course in which I'm using this resource.

The remainder of this page is Heiss' original.
